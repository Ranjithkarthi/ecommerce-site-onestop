...
const Login = ({ setToken }) => {
  // Initialize with default email and password
  const [email, setEmail] = useState("ranjithrk@gmail.com");
  const [password, setPassword] = useState("gorilla44");
...
<         p>Note: Default values for email and password are already set. Simply click login—no need to enter any information.</p>
        </form>
      </div>
    </div>
  );
