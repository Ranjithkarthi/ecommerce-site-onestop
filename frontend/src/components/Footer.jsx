    ...
    return (
        <div>
            <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
                <div>
                    <img src={assets.logo} alt="brand logo" className='mb-5 w-32' />
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-1 text-gray-600'>
                        <li>+91 8077669812</li>
                        <li>onestopsupport@gmail.com</li>
                    </ul>
                </div>
            ...
            <div>
                <hr />
                <p className='py-5 text-sm text-center'>Copyright 2024 &copy; onestop.com - All Right Reserved</p>
            </div>
        </div>
